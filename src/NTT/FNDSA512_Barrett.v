...
Section FNDSA512.
  ...
  Definition fndsa_c: F := F.of_Z _ 12265.
  ...
  Definition fndsa512_ntt := @br2_ntt 64 (Naive.word _) q n m fndsa1024_zetas word_of_F add sub mul.
  Definition fndsa512_inverse_ntt := @br2_ntt_inverse 64 (Naive.word _) q n m fndsa_c fndsa1024_zetas word_of_F add sub mul.
  ...
  Definition fndsa_funcs :=
    [ ("fndsa512_ntt", fndsa512_ntt)
    ; ("fndsa512_inverse_ntt", fndsa512_inverse_ntt)
  ...
  Lemma fndsa512_ntt_ok:
    @spec_of_ntt _ _ _ _ _ _ "fndsa512_ntt" q n m fndsa1024_zetas feval (map.of_list fndsa_funcs).
  Proof.
  ...
  Lemma fndsa512_inverse_ntt_ok:
    @spec_of_ntt_inverse _ _ _ _ _ _ "fndsa512_inverse_ntt" q n m fndsa1024_zetas feval (map.of_list fndsa_funcs).
  Proof.
  ...
  Eval compute in ToCString.c_module fndsa_funcs.
End FNDSA512.
